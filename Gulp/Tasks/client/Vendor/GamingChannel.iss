...
#define MyAppName "Gaming channel Client"
#define MyAppVersion "{{APP_VERSION}}"
#define MyAppPublisher "Gaming channel Inc."
#define MyAppURL "https://TheGaminChannel.com/"
#define MyAppExeName "Gaming channelClient.exe"
...
AppMutex=gaming-channel-client
DefaultDirName={localappdata}\GamingChannelClient
DefaultGroupName=Gaming channel
...
OutputDir={{OUT_DIR}}
OutputBaseFilename=GamingChannlClientSetup
...
CloseApplicationsFilter=GamingChannelClient.exe
...
[Files]
Source: "GamingChannelClient.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Type: files; Name: "{app}\GamingChannelClient.exe.old"
Type: files; Name: "{app}\GamingChannelClient.exe.new.exe"
  ...
  Begin
    If ( CurPageId = wpWelcome ) AND GetSquirrelUninstall( OldUninstallCmd ) Then
      CreateOutputMsgPage( CurPageId,
        ...
        'The old version of Gaming channel Client will be uninstalled before we continue.' + CRLF + 'Note, this operation cannot be undone.' + CRLF + CRLF + 'Click next to continue.' );
    Result := True;
  End;
